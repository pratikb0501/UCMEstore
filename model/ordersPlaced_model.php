<?php
    ...
    function getAllPlacedOrders(){
      $sql="SELECT products.productImage,products.productName,orders.productQuantity,products.productPrice,users.email,orders.orderDate,orders.orderID,orders.orderStatus FROM orders JOIN products JOIN users ON orders.productID=products.productID AND orders.userID=users.userID ORDER BY orders.orderID DESC;";
